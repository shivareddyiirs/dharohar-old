...
int ccDBRoot::columnCount(const QModelIndex &) const
{
	return 1;
	//if (parent.isValid())
...
bool ccDBRoot::dropMimeData(const QMimeData* data, Qt::DropAction action, int destRow, int , const QModelIndex& destParent)
{
