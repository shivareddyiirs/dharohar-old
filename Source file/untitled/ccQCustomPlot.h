...
public:
    ...
    virtual double selectTest(const QPointF &, bool , QVariant *) const { return -1; } //we don't use the QCP internal selection mechanism!

protected:
	// reimplemented virtual methods:
    virtual void drawLegendIcon(QCPPainter *, const QRectF &) const {}
    virtual QCPRange getKeyRange(bool &foundRange, SignDomain ) const { foundRange = false; return QCPRange(); }
    virtual QCPRange getValueRange(bool &foundRange, SignDomain ) const { foundRange = false; return QCPRange(); }
