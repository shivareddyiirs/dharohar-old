...
void ScalarFieldTools::SetScalarValueToNaN(const CCVector3& , ScalarType& scalarValue)
{
	scalarValue = NAN_VALUE;
}

void ScalarFieldTools::SetScalarValueToZero(const CCVector3& , ScalarType& scalarValue)
{
	scalarValue = 0;
}
...
void ScalarFieldTools::multiplyScalarFields(GenericIndexedCloud* firstCloud, GenericIndexedCloud* secondCloud, GenericProgressCallback* )
{
